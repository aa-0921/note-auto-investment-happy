...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    //   'お金 ない 生活費 足りない 家計 苦しい 支払い 困難',
    //   '借金 ローン 返済 クレジットカード 支払い 家賃 払えない',
    //   '光熱費 払えない 給料 安い 収入 減った 副業 探し',
    //   'アルバイト 探し 節約 生活 貯金 できない 貯金 ゼロ',
    //   '貯金 少ない 急な出費 医療費 困る 教育費 困る',
    //   '子供 学費 奨学金 返済 生活保護 申請 失業 無職',
    //   '転職 活動中 パート 探し シングルマザー お金 シングルファーザー お金',
    //   '老後資金 不安 年金 少ない 年金 不安 物価 高い',
    //   'インフレ 困る ガス代 高い 電気代 高い 食費 高い',
    //   '家計 見直し 生活 苦しい 生活 困窮 生活 苦労',
    // ]
    //   .join(' ')
    //   .trim()
    //   .split(/\s+/);
